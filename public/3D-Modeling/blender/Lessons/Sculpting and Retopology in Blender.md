...
![[content/3D-Modeling/attatchments/sculpting-window-areas.png]]
...
![[content/3D-Modeling/attatchments/blender-sculpt-mode-upper-left-window-menus.png]]
...
### Sculpting Tools
-  ![[content/attachments/keys-color/f-key-col.png|50]] -> resize brush
- ![[content/attachments/keys-color/cntrl-key-col.png|50]] -> subtract 
- ![[content/attachments/keys-color/shift-key-col.png|100]] -> toggle smooth brush
...
- ![[content/attachments/keys-color/alt-key-col.png|70]] + ![[content/attachments/keys-color/z-key-col.png|50]] -> enable x-ray
...
3. press ![[content/attachments/keys-color/n-key-col.png|50]] to bring up the n-panel
...
1. Add loose geometry
	1. make sure to deselect everything with ![[content/attachments/keys-color/a-key-col.png|50]]+![[content/attachments/keys-color/a-key-col.png|50]]
	2. ![[content/attachments/keys-color/alt-key-col.png|70]]+![[content/attachments/keys-color/d-key-col.png|50]] -> temporarily enable annotate tool
	3. add strokes with the annotate tool
	4. click *add surface* 
	5. tweak the options in the popup menu
2. Add to existing geo
	1. select one edge
	2. then use  ![[content/attachments/keys-color/alt-key-col.png|70]]+![[content/attachments/keys-color/d-key-col.png|50]] to add strokes
